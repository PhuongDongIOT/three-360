export default function InfoCard() {
    ...
    return (
        <div className="w-full shadow-inner bg-white/80 rounded-xl py-2 lg:py-4 px-4 lg:px-6 mx-auto">
                    ...
                    <div class="lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:gap-x-8 lg:px-8">
                        <div class="lg:pr-4">
                            <div class="w-full text-gray-700">
                                ...
                                <ul role="list" class="text-xs lg:text-sm mt-4 lg:mt-8 space-y-4 lg:space-y-8 text-gray-600">
